...
export const features = [
  {
    name: "Fast Lane in Collaboration with Zeiss",
    description:
      "Fastlane is dedicated to optimizing work processes in our measurement rooms. Our collaboration with Zeiss allows us to introduce modern technologies and precision tools, enhancing efficiency and precision in every aspect of our work.",
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
